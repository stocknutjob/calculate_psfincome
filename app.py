...
with st.expander("주의사항 및 면책 조항", expanded=True):
    st.caption("""
    1. **세법 기준**: 이 계산기는 **2025년 현행 세법**을 기반으로 합니다. 세법은 자주 바뀌므로 실제 결과와는 다를 수 있습니다.
    ...
    5. **면책 조항**: 이 계산기는 사용자의 편의를 위한 예상치 제공을 목적으로 하며, **어떠한 경우에도 재정적 조언이나 법적 자문으로 간주될 수 없습니다.** 계산 결과는 입력된 가정과 현재 세법을 기반으로 하지만, **오류가 있을 수 있으며 실제 결과와 차이가 발생**할 수 있습니다. 이용자는 이 계산기 결과에만 의존하여 투자 또는 재정 결정을 내리지 않아야 하며, 모든 재정적 결정에 대한 **최종 책임은 이용자 본인**에게 있습니다.
    """)
